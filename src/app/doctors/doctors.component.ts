...
export class DoctorsComponent implements OnInit {
  ...
  constructor(public dataService: DataService, private router: Router,private http: HttpClient, private doctorService: DoctorService) {
    doctorService.get().subscribe((data: any) => this.doctorsData = data)
